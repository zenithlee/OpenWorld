...
public struct Barycentric
{
  ...
  public Barycentric(Vector3d aV1, Vector3d aV2, Vector3d aV3, Vector3d aP)
  {
    Vector3d a = aV2 - aV3, b = aV1 - aV3, c = aP - aV3;
  ...
  */
  ...
  public Vector2d Interpolate(Vector2d v1, Vector2d v2, Vector2d v3)
  {
    return v1 * u + v2 * v + v3 * w;
  }
  public Vector3d Interpolate(Vector3d v1, Vector3d v2, Vector3d v3)
  {
    return v1 * u + v2 * v + v3 * w;
  }
  public Vector4d Interpolate(Vector4d v1, Vector4d v2, Vector4d v3)
  {
    return v1 * u + v2 * v + v3 * w;
  }
  /*

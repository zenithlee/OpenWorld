...
namespace Massive.Optimize
{
  public class Frustum
  {
    ...
    public bool PointVsFrustum(Vector3d v)
    {
      return PointVsFrustum((float)v.X, (float)v.Y, (float)v.Z);
    }
    ...
    public bool SphereVsFrustum(float x, float y, float z, double radius)
    {
      for (int p = 0; p < 6; p++)
      {
